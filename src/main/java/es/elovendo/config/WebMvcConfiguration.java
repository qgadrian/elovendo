...
public class WebMvcConfiguration extends WebMvcConfigurerAdapter {
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		registry.addResourceHandler("/**").addResourceLocations("/resources/", "/resources/sitemap/");
		registry.addResourceHandler("/css/**").addResourceLocations("/resources/css/");
		registry.addResourceHandler("/js/**").addResourceLocations("/resources/js/");
		registry.addResourceHandler("/images/**").addResourceLocations("/resources/images/");
		registry.addResourceHandler("/imgs/**") // TODO: This folder its totally
												// temporary
	...
	// FAQ: For fix error
	// "No mapping found for HTTP request with URI (..) with name 'dispatcherServlet' (..)"
	// @Override
	// public void
	...
	// FAQ: This force the default language to the setted in setDefaultLocale
	// (you have to send "?lang=en to change it)
	// @Bean
	...
	// @Bean
	// public ServletContextInitializer servletContextInitializer(ServletContext
	// servletContext) {
