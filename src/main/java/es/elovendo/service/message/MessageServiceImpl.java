...
public class MessageServiceImpl implements MessageService {
	...
	@Override
	public MessageThread createMessageThread(User sender, User receiver) throws MessageThreadAlreadyExistsException,
	...
	public Message sendMessage(User sender, User receiver, String messageText, long ipAddress)
		...
		if (sender.getUserId().equals(receiver.getUserId())) // Check if message
																// its to itself
