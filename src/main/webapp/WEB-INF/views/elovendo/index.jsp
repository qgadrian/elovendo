						...
						<div class="12u">
							...
							<!-- Header -->
								<header id="header">
									...
									<!-- Logo -->
										<div id="logo">
											<h1><a href="#" id="logo">Elovendo</a></h1>
											<span>P�gina de prueba</span>
										</div>
									...
									<!-- Nav -->
										<nav id="nav">
											<ul>
												...
												<li><a href="about2">Right Sidebar</a></li>
							...
							<!-- Banner -->
								<div id="banner" class="box">
									...
									<div>
										<div class="row">
											<div class="7u">
												<h2>Hola, esto es Elovendo.</h2>
												<p>Busca o crea tu anuncio.</p>
											</div>
											<div class="5u">
												<ul>
													<li><a href="#" class="button big fa fa-arrow-circle-right">Ok, vamos</a></li>
													<li><a href="#" class="button alt big fa fa-question-circle">Buscar</a></li>
												</ul>
											</div>
										</div>
									</div>
						...
						<div class="4u">
							...
							<!-- Box -->
								<section class="box box-feature">
									<a href="#" class="image image-full"><img src="/resources/images/pic01.jpg" alt="" /></a>
									<div class="inner">
										<header>
											<h2>Plagiando</h2>
							...
							<!-- Box -->
								<section class="box box-feature last">
									...
									<div class="inner">
										...
										Login<input type="text" name="username" size="16" maxlength="30" /> </br>
										Password<input type="text" name="password" size="16" maxlength="30" /> </br>
									...
									<section class="widget-thumbnails">
										...
										<div class="grid">
											<div class="row no-collapse half">
												<div class="6u"><a href="http://html5up.net/minimaxing/" class="image image-full"><img src="/resources/images/pic04.jpg" alt="" /></a></div>
												<div class="6u"><a href="http://html5up.net/halcyonic/" class="image image-full"><img src="/resources/images/pic05.jpg" alt="" /></a></div>
											</div>
											<div class="row no-collapse half">
												<div class="6u"><a href="http://html5up.net/arcana/" class="image image-full"><img src="/resources/images/pic06.jpg" alt="" /></a></div>
												<div class="6u"><a href="http://html5up.net/zerofour/" class="image image-full"><img src="/resources/images/pic07.jpg" alt="" /></a></div>
											</div>
										</div>
